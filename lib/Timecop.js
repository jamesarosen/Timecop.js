var Timecop = (function(){
  ...
  return {
    ...
    travel: function() {
      var date = Timecop.buildNativeDate.apply(Timecop, slice.call(arguments));
      timeStack.push(new Timecop.TimeStackItem('travel', date));
    },

    // Travel to the given Date and stop time.
    freeze: function() {
      var date = Timecop.buildNativeDate.apply(Timecop, slice.call(arguments));
      timeStack.push(new Timecop.TimeStackItem('freeze', date));
    },
