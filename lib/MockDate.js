...
Timecop.MockDate.prototype = {
  ...
  setHours:           function(hour, minute, second, millisecond) { return this._underlyingDate.setHours(hour, minute, second, millisecond); },
  setMinutes:         function(minute, second, millisecond) { return this._underlyingDate.setMinutes(minute, second, millisecond); },
  setSeconds:         function(second, millisecond) { return this._underlyingDate.setSeconds(second, millisecond); },
